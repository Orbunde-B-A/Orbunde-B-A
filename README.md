...
**Entrepreneur • Software Developer • Open Source Contributor**

Building scalable, secure, and production-ready applications across traditional and modern full-stack architectures.
...
- 🚀 **CityHackz (Virtual Marketplace Platform)**
       A digital marketplace bridging traditional informal markets with modern e-commerce solutions.  
      *Status:* Private repository • Live (https://www.cityhackz.com.ng)

- 🧠 [**Innovative Academia Hub Services Ltd.**]
      Academic Journal Management System (PKP).
      *Status:* Client Project • Live (https://www.iahiservices.com)

---


### 🔒 Private / In-Progress Projects
> The following projects are currently private repositories or under active development and are not yet deployed for public access.

- 📚 **AthenaU**  
  A course-based learning system inspired by platforms like Coursera and Udemy tailored for Africa.  
  *Status:* Private repository • Internal testing phase

- **Event Payment & QR Access System**  
  A secure payment and QR-code verification system for event entry.  
  *Status:* Client project • Private repository

📌 *Selected demos or code samples can be shared upon request.*
